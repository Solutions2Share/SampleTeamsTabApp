(function () {
    ...
    function createTabUrl() {
        return window.location.protocol + '//' + window.location.host + '/MSTeams?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}&username={userPrincipalName}&locale={locale}&channelId={channelId}';
    }
})();
